...
export default function App() {
  ...
  const loadStudentSession = useCallback(async (studentId) => {
    ...
    try {
      ...
      setTimeout(() => setActiveAgentIndex(1), 180);
      setTimeout(() => setActiveAgentIndex(2), 360);
      ...
      setTimeout(() => setActiveAgentIndex(3), 540);
      setTimeout(() => setActiveAgentIndex(4), 720);
      ...
      setTimeout(() => setActiveAgentIndex(5), 900);
    } catch (err) {
  ...
  if (loadingProgress < 100) {
    return (
      <div className="cyber-background" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
        <div className="pixel-star" style={{ top: '20%', left: '15%' }}>✦</div>
        <div className="pixel-star" style={{ top: '35%', right: '20%' }}>★</div>
        <div className="pixel-star" style={{ bottom: '25%', left: '30%' }}>✧</div>
        <div className="pixel-star" style={{ bottom: '30%', right: '15%' }}>✦</div>

        <div style={{ position: 'relative', marginBottom: '24px' }}>
          <div style={{ width: '88px', height: '88px', borderRadius: '50%', background: 'rgba(6,182,212,0.18)', border: '2px solid #06b6d4', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 0 35px rgba(6,182,212,0.6)' }}>
            <Brain size={46} color="#22d3ee" />
          </div>
        </div>
        <h1 style={{ fontSize: '32px', fontWeight: 900, letterSpacing: '-0.02em', color: '#f8fafc', marginBottom: '8px' }}>
          <span style={{ color: '#06b6d4' }}>Omega</span> Pathway Intelligence
        </h1>
        <p style={{ color: '#94a3b8', fontSize: '14px', marginBottom: '24px' }}>
          Initializing 6 Autonomous Agent Cores & Graph-RAG Policy Engine...
        </p>

        <div style={{ width: '340px', height: '8px', background: 'rgba(255,255,255,0.08)', borderRadius: '9999px', overflow: 'hidden' }}>
        ...
        <span style={{ fontSize: '11px', color: '#64748b', marginTop: '12px', fontFamily: 'monospace' }}>
      ...
      <div className="cyber-background" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '36px 16px' }}>
        ...
        <div style={{ maxWidth: '1080px', width: '100%' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '32px' }}>
            ...
            <h1 style={{ fontSize: '44px', fontWeight: 900, letterSpacing: '-0.03em', color: '#f8fafc', marginBottom: '10px' }}>
            ...
            <p style={{ color: '#94a3b8', fontSize: '16px', maxWidth: '720px', margin: '0 auto', lineHeight: '1.5' }}>
              Autonomous 6-Agent Core: Prerequisite Graph Navigation, Formal Constraint Audits, Career Velocity, & Faculty Governance.
            </p>
          </div>
